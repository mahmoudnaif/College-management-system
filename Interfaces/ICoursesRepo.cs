...
namespace College_managemnt_system.Interfaces
{
    public interface ICoursesRepo
    {
        ...
        public Task<CustomResponse<CourseDTO>> EditCreditHours(CourseEditModel courseEditModel);
        public Task<CustomResponse<CourseDTO>> EditCourseCode(CourseEditModel courseEditModel);
        public Task<CustomResponse<CourseDTO>> EditCourseName(CourseEditModel courseEditModel);
        public Task<CustomResponse<CourseDTO>> EditDepartment(CourseEditModel courseEditModel);
    }
}
