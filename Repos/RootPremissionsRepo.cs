...
{
    public class RootPremissionsRepo : IRootPremissionsRepo
    {
        private readonly IDistributedCache _distributedCache;

        public RootPremissionsRepo(IDistributedCache distributedCache)
        {
        ...
        {
            if (!await Check(key))
                return new CustomResponse<bool>(404, "Premission alreadys disables");
